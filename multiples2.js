...
function multiples(x) {
  return (x % 49 === 0 && x % 3 === 0) ? "Fang" : (x % 7 === 0) ? "Fizz" : (x % 15 === 0) ? "Foo" : "Far";
};

// Test cases
console.log(multiples(49), "Fizz")
console.log(multiples(147), "Fang")
console.log(multiples(30), "Foo")
console.log(multiples(51), "Far")
